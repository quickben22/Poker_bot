...
def inteligencija(card,jacina,znak,call,situacija2,blinds,diz,button_gdje,vide_flop,pare_uigraca,bet_raise2,check_call2,foldic2,vide_flop3,igraci_uigri,igraci_statistika,imena_igraca):
    print('umjetna4_1')
    bjezi=0
    if card[2]>0:
    ...
    vrste_igraca3=[] #nova vrsta igraca prije
    imena_prije=[]
    imena_poslije=[]
    ...
    pare_uigraca3=[] #pare u ugraca poslije mena
    vrste_igraca4=[] #nova vrsta igraca poslije
    ...
    print('raise,pot',velicina_raisea, velicina_pota)
    ...
    if max(card)==53:
        ...
        if (jacina[0]>10 and jacina[0]==jacina[1]) : #rucni par QQ ili vise+
            ...
            if call==2 and (velicina_raisea==2 or velicina_raisea==1):
                ...
                if (velicina_raisea<13 or postotak<0.60):
                    mis2.click(930,670) #raise velik gumb
                    mis2.click(750,370) #makni ga sa gumba
                    print('all in')
                else:    
        ...
        elif len(igraci_uigri)<3 and (velicina_raisea==2 and velicina_raisea!=1 ) and button_gdje!=4 and button_gdje!=5: # 2 ili manje ljudi u igri ostalo, ako je prazan stol, ovaj uvijet 
            for i in range(2):  #koliko puta raiseat
                mis2.click(1000,625) #raise jos
        ...
        elif velicina_raisea==1 and len(igraci_uigri)==1:
            for i in range(2):  #koliko puta raiseat
                mis2.click(1000,625) #raise jos
            ...
            if call==2 and velicina_raisea==1 and len(vrste_igraca)<1: # nema nikog  prije mene
                for i in range(2):  #koliko puta raiseat
                    mis2.click(1000,625) #raise jos
                mis2.click(930,670) #raise velik gumb
                mis2.click(750,370) #makni ga sa gumba
        ...
        elif button_gdje==6 and call==2 and velicina_raisea==2 and len(vrste_igraca)==0: #Button
            if situacija==1007:
    ...
    elif jacina[2]>0 and jacina[5]==0: # nakon flopa
        if situacija2==1 or situacija2==6 or situacija2==7 or situacija2==8: #prva situacija (veliki rucni par)
        ...
        elif situacija2==2 or situacija2==2002 or situacija2==9 or situacija2==10: #druga situacija, aq,ak
            hand=ruka.koja(jacina2,znak,call)
            ...
            if hand>2 and opasni_igrac!=1 and opasni_igrac!=3 and situacija2!=103: #slow playat ovo dvoje, ili ako je neko raise prije flopa 
                for i in range(blinds/2):  #koliko puta raiseat
                    mis2.click(1000,625) #raise jos
                ...
                for i in range(blinds/2):  #koliko puta raiseat         #ne smije biti vise od 2 visoke karte
                    mis2.click(1000,625) #raise jos
            ...
            if hand<3 and bjezi==1: #mega opasnost
            ...
            elif boja==1: # 4 od boje na stolu          #ili ima malo para
                if (situacija2==107 or situacija2==1007 or SPR<3):
                    ...
                    mis2.click(630,670) #fold
                    print('fold')
            elif hand==-1: #skala sa 2 strane           #malo para ostalo meni ili njemu
                if (situacija2==107 or situacija2==1007 or SPR<3):
                    for i in range(blinds):  #koliko puta raiseat
                        mis2.click(1000,625) #raise jos
                ...
                if jacina.count(jacina[0])>1: #prva karta se uparila
                    ...
                    elif call==1 and len(vrste_igraca2)==0: #nemam najjaci par,ali imam par, svi chekirali
                        for i in range(blinds/2):  #koliko puta raiseat
                            mis2.click(1000,625) #raise jos
                ...
                if jacina.count(jacina[0])>1: #prva karta se uparila
                    if jacina[0]>=max(jacina[2:]) and postotak<0.51 and (opasni_igrac!=2 and opasni_igrac!=3): #najjaci par na stolu imam, call na njegov raise
                        ...
                        if situacija2==111 or situacija2==110: #neko reraise, ne zanima me, fold
                            ...
                            if call==3 and postotak<0.45:
                                ...
                                situacija=111
                                print('allin')
                            elif call==2 and (postotak<0.35 or SPR<1.5): #mali reraise dolazimo, ili malo para ostalo
                                mis2.click(750,670) #call
                                mis2.click(750,370) #makni ga sa gumba
                                situacija=110
                                print('call')
                    ...
                    #    print('4')
                        ...
                        mis2.click(750,370) #makni ga sa gumba
                        print('fold')
                    elif call==2 and situacija2==1007 and postotak<0.3: #nije reraise
                    ...
                    if jacina[1]>=max(jacina[2:]) and postotak<0.51 and (opasni_igrac!=2 and opasni_igrac!=3): #najjaci par na stolu imam, neko je raise, call
                      ...
                      #  print('5')
                        print('call')
                    elif call==2 and situacija2==1007 and postotak<0.3:#nije reraise, ja prije flopa
                         #jako mali raise neko napravio
                        for i in range(blinds/2):  #koliko puta raiseat
                            mis2.click(1000,625) #raise jos
                    ...
                    elif call==2 and (opasni_igrac==1) and postotak<0.51: #drugi par bacam na rajse, to bi mozda trebalo promjenit ovisno o igracima
                        mis2.click(750,670) #call
                        mis2.click(750,370) #makni ga sa gumba
                        situacija=111
                    #    print('4')
            ...
            elif call==1 and len(vrste_igraca2)==0 and opasni_igrac!=4: #nemam par,ali svi chekirali, i ne smije biti calling station
                for i in range(blinds/2):  #koliko puta raiseat
                    mis2.click(1000,625) #raise jos
            ...
            elif call==2 and situacija2==1007: #nije reraise, a ja raise prije flopa
                if postotak<0.26: #jako mali raise neko napravio
                    for i in range(blinds/2):  #koliko puta raiseat
                        mis2.click(1000,625) #raise jos
...
#-----_________________________________________________________________________________________________
        ...
        if situacija2==6 or situacija2==18 : # imam set ili ful, nastavi dizat, sa rucnim parom
        ...
        elif situacija2==12 or situacija2==12 or situacija2==28 or situacija2==29: #mali rucni par, niko nije raise
            hand=ruka.koja(jacina2,znak,call)
            ...
            if karte_stol==4 or karte_stol==5 or karte_stol==1:
                ...
                if jacina.count(jacina[0])>1: #prva karta se uparila
                    if jacina[0]>=max(jacina[2:]): #najjaci par na stolu imam, ili check na 3 na stolu ili ja raise
                        ...
                        if situacija2==121 or situacija2==120: #neko reraise, ne zanima me, fold
                            ...
                            mis2.click(750,370) #makni ga sa gumba
                            print('fold')
                    elif call==1 and len(vrste_igraca2)==0 and(opasni_igrac!=2 and opasni_igrac!=3): #nije najjaci par, ali svi chek
                        for i in range(blinds/2):  #koliko puta raiseat #ne smije biti tight
                                mis2.click(1000,625) #raise jos
                ...
                if call==2:
                    ...
                    situacija=120 # checkirao, pa sam raiseo na najjaci par
                    print('all in')
            elif call==1 and len(vrste_igraca2)==0 and (opasni_igrac!=2 and opasni_igrac!=3 and opasni_igrac!=4): #nemam nis, ali svi chek
                for i in range(blinds/2):  #koliko puta raiseat                 ne smije biti ni calling station, ako nemam nis
                    mis2.click(1000,625) #raise jos
